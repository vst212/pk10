...
import pytz
from Pytrader_API_V1_04 import Pytrader_API
...
# Read in config
# CONFIG_FILE = "../../../Downloads/Compressed/PyTrader-python-mt4-mt5-trading-api-connector-drag-n-drop-master/Instrument.conf"
...
InstrumentInfo = MT.Get_instrument_info(instrument=biaodi)
...
##  LastTick = dictionary
LastTick = MT.Get_last_tick_info(instrument=biaodi)
print('')
...
print("上两条bar:",LastBars)

# Open a new order (market or pending) 新订单666+
...
# Send a new order, in this case market order  下单函数
# NewOrder = MT.Open_order(
#                 instrument='EURUSD',
#                 ordertype='buy',
#                 volume=0.01,
